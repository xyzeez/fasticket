...
const Header = ({ relativeClasses }) => {
  return (
    ...
    >
      <div className="inner grid grid-cols-3 grid-rows-1 items-center gap-x-6 px-4 py-3 md:px-8 md:py-4 lg:relative lg:grid-cols-[auto_1fr_auto_auto] lg:px-8 lg:py-[14px]">
        <Logo relativeClasses="col-start-2 lg:col-start-1 lg:col-end-2 col-end-3 row-start-1 row-end-2 mx-auto lg:mx-0 lg:mr-auto" />
